...
| `deepsearch.ts` | `deepsearch` | Multi-step AI-powered deep research |
| `search_crawl_scrape.ts` | `search_crawl_scrape` | Web search with full-page scraping |
...
| deepsearch, search_crawl_scrape | v6.1 | Web research |
...
| **v6.1-beta** | **Now** | **Multimodal Tools + Ledger** |
...
- 🧪 **Testing** — Unit tests for proxy.ts, quota.ts, and all tools/
- 📚 **Documentation** — Tool usage examples and user guides
- 🌍 **i18n** — French/English consistency, German/Spanish translations
